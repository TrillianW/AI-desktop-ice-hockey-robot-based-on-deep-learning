...
//#define CAMERA_SELECT 0 //选择摄像头，参数0,1
...
void main()
{
	...
	namedWindow("AIR HOCKEY", 1);//创建大小不可改变的串口，名称为"AIR HOCKEY"
	...
	while (true)
	{
		...
		inRange(imgHSV, Scalar(100, 70, 0), Scalar(179, 255, 255), imgThresh2);//机器人HSV阈值
